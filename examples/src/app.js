...
class App extends React.Component{
	...
	if (this.state.pageNum > this.state.totalPages){
        ...
        $.ajax({
          url: 'https://api.flickr.com/services/rest/?method=flickr.photosets.getPhotos&api_key=525f202302d634094c52cf0fd56955bd&photoset_id=72157684680169436&user_id=155649429@N03&format=json&per_page=21&page='+this.state.pageNum+'&extras=url_m,url_c,url_l,url_h,url_o',
          dataType: 'jsonp',
